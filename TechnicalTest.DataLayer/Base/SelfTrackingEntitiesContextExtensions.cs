    ...
    public static class SelfTrackingEntitiesContextExtensions
    {
        ...
        public static void ApplyChanges<TEntity>(this ObjectContext context, string entitySetName, TEntity entity) where TEntity : IObjectWithChangeTracker
        {
            ...
            try
            {
                ...
                #endregion Handle Initial Entity State
                ...
                #endregion Loop through each object state entries
        ...
        public static RelatedEnd GetRelatedEnd(this ObjectStateEntry entry, string navigationPropertyIdentity)
        {
        ...
        public static NavigationProperty GetNavigationProperty(this EntityType entityType, string navigationPropertyIdentity)
        {
            NavigationProperty navigationProperty;
        ...
        public static string GetEntitySetName(this RelatedEnd relatedEnd)
        {
        ...
        private sealed class RelationshipSet : IEnumerable<RelationshipWrapper>
        {
            ...
            #endregion IEnumerable<RelationshipWrapper>
        }
